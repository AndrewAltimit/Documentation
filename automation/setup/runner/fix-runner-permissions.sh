...
RUNNER_WORKSPACE="${GITHUB_WORKSPACE:-$HOME/Documents/repos/actions-runner-Documentation/_work}"
...
if command -v git &> /dev/null; then
    ...
    git config --global --add safe.directory "$RUNNER_WORKSPACE/Documentation" 2>/dev/null || true
    git config --global --add safe.directory "$RUNNER_WORKSPACE/Documentation/Documentation" 2>/dev/null || true
