...
class ConvexOptimization:
    ...
    @staticmethod
    def proximal_gradient_descent(f_grad: Callable, g_prox: Callable, 
                                 x0: np.ndarray, step_size: float, 
                                 n_iter: int) -> Tuple[np.ndarray, List[float]]:
        """
    ...
    @staticmethod
    def accelerated_gradient_descent(f_grad: Callable, x0: np.ndarray, 
                                   L: float, n_iter: int) -> Tuple[np.ndarray, List[float]]:
        """
    ...
    @staticmethod
    def admm(A: np.ndarray, b: np.ndarray, lambda_reg: float, 
             rho: float, n_iter: int) -> Tuple[np.ndarray, np.ndarray, List[float]]:
        """
...
class KernelTheory:
    ...
    @staticmethod
    def mercer_kernel_expansion(kernel_func: Callable, 
                               eigenvalues: np.ndarray, 
                               eigenfunctions: List[Callable]) -> Callable:
        """
    ...
    @staticmethod
    def rkhs_norm(f: Callable, kernel_func: Callable, 
    ...
    @staticmethod
    def kernel_ridge_regression(X: np.ndarray, y: np.ndarray, 
                               kernel_func: Callable, 
                               lambda_reg: float) -> Callable:
        """
    ...
    @staticmethod
    def kernel_pca(X: np.ndarray, kernel_func: Callable, 
