...
class ContainerdClient:
    ...
    async def pull_image(
        self, ref: str, platform: Optional[Dict[str, str]] = None
    ) -> str:
        """
    ...
    async def create_container(
        self, id: str, image: str, config: Dict[str, Any]
    ) -> str:
        """
    ...
    async def start_container(
        self, container_id: str, exec_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def exec_container(
        self, container_id: str, cmd: List[str], exec_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        exec_config = {
            "container_id": container_id,
            "exec_id": exec_id,
            "spec": {"args": cmd, "env": [], "cwd": "/", "user": {"uid": 0, "gid": 0}},
            "stdin": "/dev/null",
    ...
    def _get_resources(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "pids": {"limit": config.get("pids_limit", -1)},
        }
...
async def main():
    ...
    try:
        ...
        exec_info = await client.exec_container(
            container_id, ["cat", "/etc/os-release"]
        )
