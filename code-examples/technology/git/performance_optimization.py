...
class PerformanceAnalyzer:
    ...
    def analyze_pack_files(self) -> PackStats:
        ...
        stats = PackStats(
            num_packs=0, total_size=0, num_objects=0, delta_objects=0, efficiency=0.0
        )
    ...
    def generate_recommendations(self, report: PerformanceReport) -> List[str]:
        ...
        if loose_count > 1000:
            recommendations.append(f"Run 'git gc' to pack {loose_count} loose objects")
    ...
    def is_large_repository(self) -> bool:
        ...
        return stats.total_size > 1024 * 1024 * 1024 or stats.num_objects > 100000
...
def demo_performance_analysis():
    ...
    report = PerformanceReport(
        ...
        ref_stats={"num_refs": 150, "num_loose_refs": 120, "num_packed_refs": 30},
        worktree_stats={
            "num_files": 5000,
            "total_size": 100 * 1024 * 1024,  # 100MB
            "large_files": [{"path": "data/large.bin", "size": 25 * 1024 * 1024}],
        },
        recommendations=[],
    )
