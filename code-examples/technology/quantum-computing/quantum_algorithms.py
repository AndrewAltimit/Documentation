...
from quantum_gates import QuantumGates, QuantumCircuit
...
class QuantumPhaseEstimation:
    ...
    @staticmethod
    def qpe_circuit(unitary: np.ndarray, 
                   eigenvector: np.ndarray,
                   precision_qubits: int) -> QuantumCircuit:
        """
...
class HHLAlgorithm:
    ...
    def __init__(self, A: np.ndarray, b: np.ndarray, 
                 precision: int = 4, evolution_time: float = 2*np.pi):
        """
