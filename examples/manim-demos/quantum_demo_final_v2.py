...
class QuantumDemoFinal(ThreeDScene):
    def construct(self):
        ...
        self.play(Write(end[0]), Write(end[1]), run_time=0.5)
        self.wait(0.5)
    ...
    def entanglement_spooky(self):
        ...
        self.play(Create(distance_arrow), Write(distance_text), run_time=0.4)
        ...
        self.play(Write(measure_a), Flash(particle_a[0], color=GREEN), run_time=0.4)
        ...
        self.play(Write(result_a), Write(result_b), run_time=0.3)
        ...
        self.play(Write(spooky_text), Write(einstein), run_time=0.6)
    ...
    def quantum_gates_circuit(self):
        ...
        self.play(Create(qubit_lines), Write(init_states), run_time=0.4)
        ...
        self.play(Write(entangle_effect), Create(connection_effect), run_time=0.4)
    ...
    def quantum_supremacy(self):
        ...
        self.play(Write(apps_title), Write(apps), run_time=0.6)
