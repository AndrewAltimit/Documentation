...
class GarbledCircuit:
    ...
    def garble_gate(self, gate_type, input_wires, output_wire):
        ...
        for wire in input_wires + [output_wire]:
            if wire not in self.wire_labels:
                self.wire_labels[wire] = {0: os.urandom(16), 1: os.urandom(16)}
    ...
    def garble_circuit(self, circuit):
        ...
        garbled_circuit = {"gates": {}, "output_map": {}, "input_labels": {}}
...
class SecureMultipartyComputation:
    ...
    def bgw_protocol(parties, inputs, circuit, threshold):
        ...
        for party, value in inputs.items():
            ...
            shares = SecureMultipartyComputation._shamir_share(value, threshold, n)
        ...
        for gate in circuit["gates"]:
            if gate["type"] == "ADD":
                ...
                output_shares = [
                    (a[0] + b[0]) % gate["modulus"] for a, b in zip(a_shares, b_shares)
                ]
    ...
    def _shamir_share(secret, threshold, num_shares):
        ...
        coefficients = [secret]
        coefficients.extend([random.randrange(1, 1000000) for _ in range(threshold)])
