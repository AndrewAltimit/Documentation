...
class ContainerRuntime:
    ...
    def create_oci_bundle(self, rootfs_path: str, config: Dict[str, Any]) -> str:
        ...
        oci_config = {
            ...
            "process": {
                ...
                "user": {"uid": config.get("uid", 0), "gid": config.get("gid", 0)},
    ...
    def _get_resources(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "pids": {"limit": config.get("pids_limit", 32768)},
            "blockIO": {
            ...
            "hugepageLimits": [],
            "network": {"classID": config.get("net_cls_classid", 0), "priorities": []},
        }
    ...
    async def run_container(self, bundle_path: str, container_id: str) -> int:
        ...
        cmd = [self.runtime_path, "run", "-b", bundle_path, container_id]
    ...
    async def exec_container(self, container_id: str, cmd: List[str]) -> int:
        ...
        exec_cmd = [self.runtime_path, "exec", container_id] + cmd
