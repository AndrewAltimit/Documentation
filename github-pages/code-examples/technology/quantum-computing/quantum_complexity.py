...
class QuantumComplexity:
    ...
    @staticmethod
    def qma_verifier(witness: QuantumState, 
                    verification_circuit: QuantumCircuit) -> bool:
        """
...
class QuantumSupremacy:
    ...
    @staticmethod
    def random_circuit_sampling(n_qubits: int, depth: int, 
    ...
    @staticmethod
    def cross_entropy_benchmarking(experimental_samples: List[str],
                                  ideal_probabilities: Dict[str, float]) -> float:
        """
    ...
    @staticmethod
    def boson_sampling(n_photons: int, n_modes: int, 
                      unitary: np.ndarray) -> List[List[int]]:
        """
    ...
    def _sample_photon_distribution(probabilities: np.ndarray) -> List[int]:
        ...
        positions = np.random.choice(n_modes, size=n_photons, p=probabilities/probabilities.sum())
