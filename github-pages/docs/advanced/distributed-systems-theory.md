...
- **[Quantum Algorithms](../advanced/quantum-algorithms-research/)** - Quantum distributed computing and Byzantine agreement
- **[Monorepo Strategies](../advanced/monorepo/)** - Managing distributed system codebases at scale
