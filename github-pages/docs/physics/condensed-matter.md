...
<div class="crystal-section">
  ...
  <div class="lattice-visual">
    ...
    <div class="lattice-examples">
      <svg viewBox="0 0 720 280" class="lattice-diagram" style="min-width: 600px; background: #fafbfc; border-radius: 8px;">
        <!-- Simple Cubic -->
  ...
  <div class="reciprocal-lattice">
    ...
    <div class="brillouin-zone">
      ...
      <svg viewBox="0 0 450 280" class="brillouin-diagram" style="min-width: 400px; background: #fafbfc; border-radius: 8px;">
        <!-- Title -->
  ...
  <div class="xray-diffraction">
    ...
    <div class="bragg-law">
      ...
      <svg viewBox="0 0 500 300" class="bragg-diagram" style="min-width: 450px; background: #fafbfc; border-radius: 8px;">
        <!-- Title -->
...
<div class="band-theory-section">
  <div class="bloch-theorem">
    ...
    <div class="bloch-visual">
      <svg viewBox="0 0 550 280" style="min-width: 500px; background: #fafbfc; border-radius: 8px;">
        <!-- Title -->
  ...
  <div class="band-models">
    <div class="model-card nfe">
      ...
      <svg viewBox="0 0 420 300" class="band-diagram" style="min-width: 380px; background: #fafbfc; border-radius: 8px;">
        <!-- Title -->
    ...
    <div class="model-card tight-binding">
      ...
      <svg viewBox="0 0 420 300" class="tb-diagram" style="min-width: 380px; background: #fafbfc; border-radius: 8px;">
        <!-- Title -->
  ...
  <div class="density-of-states">
    ...
    <div class="dos-plots">
      <svg viewBox="0 0 650 280" style="min-width: 600px; background: #fafbfc; border-radius: 8px;">
        <!-- Main title -->
...
<div class="superconductivity-section">
  <div class="phenomenology">
    ...
    <div class="phenomenon-cards">
      <div class="phenomenon-card">
        ...
        <p>Below $T_c$</p>
        <div class="mini-plot">
          <svg viewBox="0 0 180 140" style="min-width: 160px; background: #fafbfc; border-radius: 6px;">
            <!-- Title -->
    ...
    <div class="theory-card bcs-theory">
      ...
      <div class="bcs-content">
        ...
        <div class="cooper-pair-visual">
          <svg viewBox="0 0 400 180" style="min-width: 380px; background: #fafbfc; border-radius: 8px;">
            <!-- Title -->
  ...
  <div class="josephson-effects">
    ...
    <div class="josephson-junction">
      <svg viewBox="0 0 500 220" style="min-width: 450px; background: #fafbfc; border-radius: 8px;">
        <!-- Title -->
