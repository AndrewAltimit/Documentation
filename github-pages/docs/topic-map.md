...
<div class="quick-start-grid">
  <div class="quick-start-card">
    ...
    <ul>
      <li><a href="/docs/technology/git-crash-course/">Git in 5 Minutes</a></li>
      <li><a href="/docs/technology/docker-crash-course/">Docker in 5 Minutes</a></li>
      <li><a href="/docs/technology/database-crash-course/">Databases in 5 Minutes</a></li>
      <li><a href="/docs/technology/ai-fundamentals-simple/">AI in 5 Minutes</a></li>
    </ul>
  </div>
  ...
  <div class="quick-start-card">
    ...
    <ul>
      <li><a href="/docs/technology/branching/">Git Branching Strategies</a></li>
      <li><a href="/docs/technology/docker/">Docker Deep Dive</a></li>
      <li><a href="/docs/technology/database-design/">Database Design Patterns</a></li>
      <li><a href="/docs/technology/ai/">AI & Neural Networks</a></li>
    </ul>
  </div>
  ...
  <div class="quick-start-card">
    ...
    <ul>
      <li><a href="/docs/technology/git/">Git Internals & Theory</a></li>
      <li><a href="/docs/technology/kubernetes/">Kubernetes Architecture</a></li>
      <li><a href="/docs/advanced/distributed-systems-theory/">Distributed Systems</a></li>
      <li><a href="/docs/technology/ai-lecture-2023/">Advanced AI Theory</a></li>
    </ul>
  </div>
</div>
