...
class QuantumDemoClean(Scene):
    ...
    def qubit_superposition(self):
        # Title (0.3s)
        title = Text("Superposition", font_size=40, color=GREEN)
        title.to_edge(UP)
        ...
        or_text = Text("OR", font_size=18).shift(LEFT * 4 + UP * 0.5)
    ...
    def measurement_collapse(self):
        # Title
        title.become(Text("Measurement", font_size=40, color=RED))
    ...
    def entanglement_demo(self):
        # Title
        title.become(Text("Entanglement", font_size=40, color=PURPLE))
    ...
    def quantum_gates(self):
        # Title
        title.become(Text("Quantum Gates", font_size=40, color=YELLOW))
    ...
    def quantum_advantage(self):
        # Title
        title.become(Text("Quantum Advantage", font_size=40, color=GOLD))
