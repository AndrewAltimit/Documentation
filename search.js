...
(function() {
    ...
    const PAGES = [
        ...
        { url: 'docs/physics/classical-mechanics/', title: 'Classical Mechanics', category: 'physics' },
        { url: 'docs/physics/thermodynamics.html', title: 'Thermodynamics', category: 'physics' },
        { url: 'docs/physics/statistical-mechanics/', title: 'Statistical Mechanics', category: 'physics' },
        { url: 'docs/physics/relativity/', title: 'Relativity', category: 'physics' },
        { url: 'docs/physics/quantum-mechanics/', title: 'Quantum Mechanics', category: 'physics' },
        { url: 'docs/physics/condensed-matter/', title: 'Condensed Matter Physics', category: 'physics' },
        { url: 'docs/physics/quantum-field-theory.html', title: 'Quantum Field Theory', category: 'physics' },
        { url: 'docs/physics/string-theory/', title: 'String Theory', category: 'physics' },
        ...
        { url: 'docs/technology/database-design/', title: 'Database Design', category: 'technology' },
        { url: 'docs/technology/networking/', title: 'Networking', category: 'technology' },
        { url: 'docs/technology/cybersecurity/', title: 'Cybersecurity', category: 'technology' },
        { url: 'docs/technology/git/', title: 'Git Version Control', category: 'technology' },
        ...
        { url: 'docs/technology/ai/', title: 'Artificial Intelligence', category: 'technology' },
